...
?>
		...
		<footer class="bg-footer">
			<div class="container">
				<a href="#"><img src="<?php echo get_template_directory_uri() ?>/assets/img/NEXAIR BLANC+BASE LINE.svg" alt="nexair ingenerie traitement de l'air" class="logo-footer"/></a>
            ...
            ?>
				...
				<div class="d-f">
					...
					<a href="https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Fwww.nexair.fr%2F"><img src="<?php echo get_template_directory_uri() ?>/assets/img/Linkedin.svg" alt="linkedin" class="linkedin"></a>
